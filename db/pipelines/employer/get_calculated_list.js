...
let composeGetCalculatedListAgg = ({
  companyID,
  deptID,
  employeeID,
  from,
  ...
  to = !!to
    ...
    let agg = [{
         ...
         cond: {
          $and: [
           ...
           },
           {
            $and: [
             {
             $lte:[{$ifNull: [to,'$$withdrawal.status.updatedAt']}, '$$withdrawal.status.updatedAt']
             },
             {
             $gte:[ {$ifNull: [from,'$$withdrawal.status.updatedAt']}, '$$withdrawal.status.updatedAt']
             },
            ]
           }
          ]
      ...
      $set: {
       ...
       employeeReconciledDebt:{$sum:["$sumWithdrawal", "$sumWithdrawalFeesByEmployer"]}
      }
     }, {
      $unset: [
       'users',
