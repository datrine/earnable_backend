let current_session = {
    ...
    /**
     * @type {[{factor:"email"|"direct"|"phonenum",time:Date}]}
     */
...
let verInfo = {
    /**
     * @type [{factor:"email"|"mobile",tokenSent:false, isVerified:false,timeInitiatized:Date,timeVerified:Date}]
     */
    status: [],
    /**
     * @type {boolean}
